...
DDS_list <- DDS_list[1:48] 
DESeq_Results_Index <- DESeq_Results_Index[1:48,]
...
do.call(
  ...
  c(
    ...
    file=paste0(
      "../Data/tmp/", 
      "C7_1_DA_ATAC_WNN_SVA_AllCase_LinkPeaks_Pre", 
      ".qrdata"
    ), 
    nthr=nthr
  )
...
rm(list=ls())
      ...
      # Y_C7_1_DA_ATAC_WNN_SVA_AllCase_Slurm.R, Files 1-15 ---------------------
...
for (i in 1:15){
  ...
  DDS_List <- qread(
    file=paste0(
      "../Data/DA/WNN/Pseudobulk/DESeq2/AllCase_LinkPeaks/SVA/1_15_SVs/DDS_", 
      i, 
      "SVs_list", 
      ".qrds"
    ), 
