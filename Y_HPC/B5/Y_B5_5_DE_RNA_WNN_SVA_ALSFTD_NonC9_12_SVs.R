...
qreadm("./B5_5_DE_12SVA_ALSFTD_NonC9_Pre.qrdata",nthr=40)
...
for (i in 1:nrow(DESeq_SVA_12sv_Results_Index)){ 
  tryCatch({
    ...
    if(DESeq_SVA_12sv_Results_Index$Comparison[i]=="NonC9_ALSFTDvsHC"){
  ...
  do.call(qsavem,c(lapply(ls(), as.symbol), file="./B5_5_DE_12SVA_ALSFTD_NonC9_Post.qrdata ", nthr=40))
  print("Job done!...")
