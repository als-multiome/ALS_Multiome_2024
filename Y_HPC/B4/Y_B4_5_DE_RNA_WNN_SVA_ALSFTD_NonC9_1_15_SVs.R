...
for (nSVs in 1:15){
  ...
  DDS_list <- qread(paste0("./SVA_ALSFTD_NonC9/DDS_", nSVs, "SVs_list.qrds"),nthr=40)
  ...
  for (i in 1:length(DDS_list)){
    ...
    if(i%%2==1){
      message(paste0("Comparing HC, ALS-FTD-NonC9 and assigning the results under index nr. ", i, "... ")) 
    }else{
