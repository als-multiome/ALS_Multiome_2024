...
for (nSVs in 1:14){
  ...
  DDS_list <- qread(paste0("./SVA_ALSFTD_C9_NonC9/DDS_", nSVs, "SVs_list.qrds"),nthr=40)
  ...
  for (i in 1:length(DDS_list)){
    ...
    if(i%%2==1){
      message(paste0("Comparing ALS_FTD-C9, ALS-FTD-NonC9 and assigning the results under index nr. ", i, "... ")) 
    }else{
