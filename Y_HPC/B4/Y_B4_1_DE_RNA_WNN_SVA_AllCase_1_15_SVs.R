...
for (nSVs in 1:15){
  ...
  DDS_list <- qread(paste0("./DDS_", nSVs, "SVs_list.qrds"),nthr=40)
  ...
  for (i in 1:length(DDS_list)){
    ...
    if(i%%2==1){
      message(paste0("Comparing HC, ALS and ALS-FTD and assigning the results under index nr. ", i, "... ")) 
    }else{
      message(paste0("Comparing Rand1, Rand2 and Rand3, assigning the results under index nr. ", i, "... ")) 
    }
