...
qreadm("./C2_4_DA_ATAC_WNN_Pre.qrdata",nthr=40)
...
for (pseudobulk_index in 1:nrow(ATAC_Psdblk_WNN_Matrices_Index)){
  ...
  message(paste0("Comparing C9_ALS_FTD and HC, asssigning the results under index nr. ", index, "... ")) 
  ...
  DESeq_Results_Index$Comparison[index] <- "C9_ALSFTDvsHC" 
...
do.call(qsavem,c(lapply(ls(), as.symbol), file="./C2_4_DA_ATAC_WNN_Post.qrdata", nthr=40))
print("Job done!...")
